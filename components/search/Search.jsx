...
import { BOOKS_DATA_MAPPER, BOOKS_URL } from "../../utls/constants";
  ...
  return (
    <div className={styles.container}>
      <div className={styles.searchContainer}>
        <input className={styles.inputSearch} placeholder="Search Books Now!" onChange={handleInputChange} onKeyDown={handleKeyDown} data-testid="search-input" />
